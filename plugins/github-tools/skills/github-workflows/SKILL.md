...
- Inspect and preserve uncommitted changes. Follow existing commit/push authority; never stash or include unrelated work automatically. A requested local PR-body draft can proceed without a clean tree or network access.
